                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">{{ $searchRankings->pin_name }}</h1>
                                        @if($bookmark != null)
                                            {{-- お気に入り設定されていれば --}}
                                            @foreach($bookmark as $bookmarks)
                                                @if ($bookmarks->pin_id == $searchRankings->id)
                                    ...
                                    <div class="modal-footer">
                                        <div>いいね<i class="fa-solid fa-heart" style="color: #ff0088;"></i>{{ $searchRankings->like_count }}</div>
        ...
        @foreach ($ranking as $rankings)
            ...
            <div class="modal fade" id="example{{ $rankings->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">{{ $rankings->pin_name }}</h1>
                                @if($bookmark != null)
                                    {{-- お気に入り設定されていれば --}}
                                    @foreach($bookmark as $bookmarks)
                                        @if ($bookmarks->pin_id == $rankings->id)
                            ...
                            <div class="modal-footer">
                                <div>いいね<i class="fa-solid fa-heart" style="color: #ff0088;"></i>{{ $rankings->like_count }}</div>
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">閉じる</button>
                    </div><!-- /.modal-footer -->
                </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
        ...
        @foreach ($food as $food_data)
            ...
            <div class="modal fade" id="example{{ $food_data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">{{ $food_data->pin_name }}</h1>
                            @if($bookmark != null)
                                {{-- お気に入り設定されていれば --}}
                                @foreach($bookmark as $bookmarks)
                                    @if ($bookmarks->pin_id == $food_data->id)
                    ...
                    <div class="modal-footer">
                        <div>いいね<i class="fa-solid fa-heart" style="color: #ff0088;"></i>{{ $food_data->like_count}}</h1></div>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">閉じる</button>
                    </div><!-- /.modal-footer -->
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        ...
        @foreach ($hotel as $hotel_data)
            ...
            <div class="modal fade" id="example{{ $hotel_data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">{{ $hotel_data->pin_name }}</h1>
                                @if($bookmark != null)
                                    {{-- お気に入り設定されていれば --}}
                                    @foreach($bookmark as $bookmarks)
                                        @if ($bookmarks->pin_id == $hotel_data->id)
                    ...
                    <div class="modal-footer">
                        <div>いいね<i class="fa-solid fa-heart" style="color: #ff0088;"></i>{{ $hotel_data->like_count}}</div>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">閉じる</button>
                    </div><!-- /.modal-footer -->
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        ...
        @foreach ($culture as $culture_data)
            ...
            <div class="modal fade" id="example{{ $culture_data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div>いいね<i class="fa-solid fa-heart" style="color: #ff0088;"></i>{{ $culture_data->like_count}}</div>
        ...
        @foreach ($amusement as $amusement_data)
            ...
            <div class="modal fade" id="example{{ $amusement_data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        <div>いいね<i class="fa-solid fa-heart" style="color: #ff0088;"></i>{{ $amusement_data->like_count}}</div>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">閉じる</button>
                    </div><!-- /.modal-footer -->
                </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
        ...
        @foreach ($nature as $nature_data)
            ...
            <div class="card">
                ...
                <div class="modal fade" id="example{{ $nature_data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel">
                    ...
                    <div class="modal-footer">
                        <div>いいね<i class="fa-solid fa-heart" style="color: #ff0088;"></i>{{ $nature_data->like_count}}</div>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">閉じる</button>
                    </div><!-- /.modal-footer -->
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
