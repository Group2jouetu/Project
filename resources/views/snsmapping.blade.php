            ...
            <div class="card-body">
                ...
                <div class="accordion" id="accordionExample5">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse17" aria-expanded="true" aria-controls="collapseOne">
                                A.松ヶ峯
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse18" aria-expanded="false" aria-controls="collapseTwo">
                                B.上越清里 星のふるさと館
                            </button>
                        </h2>
            ...
            <div class="card-body">
                ...
                <div class="accordion" id="accordionExample6">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse21" aria-expanded="true" aria-controls="collapseOne">
                                A.上越市立水族博物館 うみがたり
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse22" aria-expanded="false" aria-controls="collapseTwo">
                                B.瞽女ミュージアム高田
                            </button>
                        </h2>
            ...
            <div class="card-body">
                ...
                <div class="accordion" id="accordionExample7">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse25" aria-expanded="true" aria-controls="collapseOne">
                                A.光ヶ原高原センター
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse26" aria-expanded="false" aria-controls="collapseTwo">
                                B.上越清里 星のふるさと館
                            </button>
                        </h2>
            ...
            <div class="card-body">
                ...
                <div class="accordion" id="accordionExample8">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse29" aria-expanded="true" aria-controls="collapseOne">
                                A.関田峠
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse30" aria-expanded="false" aria-controls="collapseTwo">
                                B.虫川の大杉
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapse31" aria-expanded="false" aria-controls="collapseThree">
                                C.板山不動尊
                            </button>
                        </h2>
        ...
        <div class="modal-content">
            ...
            <form action="/snsInput" id="pinForm" method="post" enctype="multipart/form-data">
                    ...
                    <li class="ly_snsmap_li_1">
                        <div class="ly_snsmap_li_div_left">
                            ...
                            <div class="input-wrapper">
                                <input class="maxlength showCount form-control" data-maxlength="30" type="text"
                                    name="pin_name" id="title" size="30" placeholder="ピンの名前（30文字以内）"
                                    value="" />
                            </div>
                            <label for="select-genre" class="janru">ジャンルを以下から選択（必須）</label><br>
                            <select name="select_genre" id="select-genre" class="form-select"
                ...
                <div class="ly_snsmap_center_div">
                    ...
                    <textarea class="maxlength showCount form-control" data-maxlength="100" name="detail" id="detail"
                        rows="5" cols="50" placeholder="口コミを入力してください（100文字以内）" required></textarea>
                </div>
                ...
                <div class="ly_snsmap_2buttons">
                    ...
                    <input type="submit" value="登録" class="btn btn-primary btn-lg" data-bs-toggle="modal"
                        data-bs-target="#exampleModal" onclick="dialogSubmit(event)">
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="btn-custom_left" data-bs-dismiss="modal"
                        onclick="closeSecondModalAndOpenFirstModal()">いいえ</button>
                    <button type="button" class="btn btn-primary" id="btn-custom_right"
                        onclick="saveAction()">はい</button>
                </div>
            </div>
        </div>
    </div>
